...
import vn.edu.kma.trade_logistics_service.security.JwtTokenService;
            ...
            public Message<?> preSend(Message<?> message, MessageChannel channel) {
                ...
                if (StompCommand.SUBSCRIBE.equals(accessor.getCommand())) {
                    ...
                    if (accessor.getUser() == null
                            || (!"/user/queue/orders".equals(destination)
                            && !"/user/queue/blockchain-updates".equals(destination))) {
