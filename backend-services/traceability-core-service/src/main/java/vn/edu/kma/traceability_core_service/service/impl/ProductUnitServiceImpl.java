...
import vn.edu.kma.traceability_core_service.dto.response.ProductUnitGeneratedItem;
import vn.edu.kma.traceability_core_service.dto.response.ProductUnitPublicTraceResponse;
import vn.edu.kma.traceability_core_service.dto.response.TraceHistoryEvent;
...
import vn.edu.kma.traceability_core_service.client.TradeLogisticsClient;
import vn.edu.kma.traceability_core_service.repository.*;
import vn.edu.kma.traceability_core_service.service.ProductUnitService;
import vn.edu.kma.traceability_core_service.utils.BlockchainVerificationUtils;
                        ...
                        for (Map<String, Object> tr : res.getResult()) {
                            if ("ACCEPTED".equals(tr.get("status"))) {
                                ...
                                events.add(TraceHistoryEvent.builder()
                                        ...
                                        .actorId((String) tr.get("toUserId")) // Người nhận
