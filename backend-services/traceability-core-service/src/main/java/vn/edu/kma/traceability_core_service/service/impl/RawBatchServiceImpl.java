...
import vn.edu.kma.traceability_core_service.dto.request.RawBatchCreateRequest;
import vn.edu.kma.traceability_core_service.dto.request.RawBatchMergeRequest;
import vn.edu.kma.traceability_core_service.dto.response.RawBatchResponse;
...
import vn.edu.kma.traceability_core_service.service.RawBatchService;
...
public class RawBatchServiceImpl implements RawBatchService {
    ...
    public Map<String, String> createRawBatch(RawBatchCreateRequest request, String token) {
        try {
            ...
            vn.edu.kma.traceability_core_service.event.BlockchainRecordBatchEvent event = 
                vn.edu.kma.traceability_core_service.event.BlockchainRecordBatchEvent.builder()
